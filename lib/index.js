    ...
    EPub = class EPub {
      ...
      generateTempFile() {
        ...
        _.each(this.options.content, function (content) {
          ...
          data +=
            content.title && self.options.appendChapterTitles ? `<h1>${entities.encodeXML(content.title)}</h1>` : '';
          data +=
        ...
        opfPath =
          ...
          path.resolve(__dirname, `../templates/epub${self.options.version}/content.opf.ejs`);
        ...
        htmlTocPath =
          ...
          path.resolve(__dirname, `../templates/epub${self.options.version}/toc.xhtml.ejs`);
